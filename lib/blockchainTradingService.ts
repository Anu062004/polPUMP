...
class BlockchainTradingService {
  ...
  // Contract addresses from Polygon Amoy testnet deployment
  // Updated: 2025-11-06 - All contracts deployed to Polygon Amoy
  private FACTORY_ADDRESS = process.env.NEXT_PUBLIC_UNISWAP_FACTORY_ADDRESS || '0x1Aa3fCC63f08103b20d8F34BaD6aE59dc6B10e45'
  private ROUTER_ADDRESS = process.env.NEXT_PUBLIC_ROUTER_ADDRESS || '0xcC33bc5336A2D99515A916A52664ecdb761e79c5'
  private WETH_ADDRESS = process.env.NEXT_PUBLIC_WETH_ADDRESS || '0x0D94Dec8cE5792A86E4b95aF2E516c0A70042Aa1'
  ...
  async initialize(provider: ethers.providers.Web3Provider) {
    ...
    try {
      const primary = (typeof process !== 'undefined' && (process as any).env && (process as any).env.NEXT_PUBLIC_EVM_RPC) || 'https://polygon-amoy.infura.io/v3/b4f237515b084d4bad4e5de070b0452f'
