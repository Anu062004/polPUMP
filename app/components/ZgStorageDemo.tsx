...
export const ZgStorageDemo = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      <h2 className="text-2xl font-bold mb-6 text-center">Storage Demo</h2>
      
      {!address && (
        <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mb-4">
          Please connect your wallet to use storage
        </div>
      )}
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          >
            {uploadFileMutation.isPending ? 'Uploading...' : 'Upload to Storage'}
          </button>
        ...
        {uploadedHash && (
          <div>
            ...
            >
              {downloadFileMutation.isPending ? 'Downloading...' : 'Download from Storage'}
            </button>
