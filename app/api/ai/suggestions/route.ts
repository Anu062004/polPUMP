...
// Use isolated AI Compute runtime with SDK 0.4.3 and ethers v6
...
async function getSuggestionsFromCompute() {
  ...
  const messages = [{ role: 'user', content: 'Based on polpump trading data, suggest 5 trending tokens. Reply as JSON array of { token, symbol, address, summary }' }]
